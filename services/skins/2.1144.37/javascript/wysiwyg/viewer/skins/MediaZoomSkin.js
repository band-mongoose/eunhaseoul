define.skin('wysiwyg.viewer.skins.MediaZoomSkin', function(SkinDefinition) {
    ...
    def.css([
        ...
        '%itemsContainer%{}',
		'%.btn% { position:fixed; top: 0px; width:100px; height:100%; background:url([tdr]arrows_white.png) no-repeat; overflow:hidden; text-indent:-9999px; cursor:pointer; opacity:0.3;}',
