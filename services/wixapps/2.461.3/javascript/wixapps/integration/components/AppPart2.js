...
//	def.propertiesSchemaType();
    ...
    def.methods({
        ...
        /**
         *
         * @param dataSelector {BaseDataSelector}
         */
        setDataSelector: function (dataSelector) {
            if(this._dataSelector) {
                var dataSelectorRepo = this._appInstance.getDataSelectors();
                var id = this._dataSelector.getId();
                // TODO: Add update instance method to BaseRepository.
                this._removeDataSelectorEvents();
                dataSelectorRepo.remove(id);
                dataSelectorRepo.registerWithId(id, dataSelector);
            }
            this._dataSelector = dataSelector;
            this._addDataSelectorEvents();
            ...
            var onSuccess = function(data) {
                // Do some verification before setting the data on the appPart.
                ...
                this.fireEvent(Constants.WixAppEvents.DATA_SELECTOR_CHANGED, dataSelector);
            }.bind(this);
            this._dataSelector.getData(onSuccess, this._onError);
        },

        /**
         * Place holder for ServerPagination experiment
         * @private
         */
        _addDataSelectorEvents: function (){

        },

        /**
         * Placerholder for serverpagination experiment
         * @private
         */
        _removeDataSelectorEvents: function (){
        ...
        _itsDeadJim: function (error) {
            ...
            this._dataSelector.getData(function (data) {
        ...
        _initApp: function () {
            ...
            var dataSelector = dataSelectorRepo.getById(selectorId);
            this.resources.W.Commands.executeCommand('ApplicationPerformanceSpy.logPhase2', { step: 'requesting items from server', appPart: this });
            this.setDataSelector(dataSelector);
